...
void Grafo::prim() {
    vector<int> chave(this->numVertices, INT8_MAX); // Valores de chave para cada vértice
    vector<int> parent(this->numVertices, -1); // Array para armazenar a árvore MST
    vector<bool> inMST(this->numVertices, false); // To represent set of vertices not yet included in MST
    ...
    cout << "Arestas da AGM usando Prim:" << endl;
    for (int i = 1; i < this->numVertices; ++i) {
        cout << "(" << parent[i] << ", " << i << ") peso: " << chave[i] << endl;
    }
}
